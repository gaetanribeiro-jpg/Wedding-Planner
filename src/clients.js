...
import { CLIENTS, PALIERS, STYLES, STYLE, PRENOMS, LIEUX_TXT,
         SAISON, SLOTS, SLOT } from "./config.js";
...
export function creerProspect(jour, palier, saison){
  ...
  return {
    ...
    exigence: Math.round(CLIENTS.EXIGENCE_BASE
 ...
 */
export const capacite = palier =>
  CLIENTS.CAPACITE_BASE + CLIENTS.CAPACITE_PAR_PALIER * (palier - 1);
...
export function ficheCouple(c){
  return {
    ...
    exigence:c.exigence, lieuTxt:c.lieuTxt,
